...
import (
	...
	"github.com/Pippolo84/threader/internal/model"
	"github.com/Pippolo84/threader/internal/retry"
	"github.com/Pippolo84/threader/internal/service"
	"github.com/Pippolo84/threader/internal/validate"
...
func NewBroker() *Broker {
	...
	broker.client = retry.NewDefaultClient(
		retry.JitteredExponential{
			Exponential: retry.Exponential{Quantum: 5 * time.Millisecond},
		},
		3,
	)
